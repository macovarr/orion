...
filters = {
    ('welcome', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'required': ['msg'], 'properties': {'msg': {'type': 'string'}}, 'additionalProperties': False}}},
    ('floor_count', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'required': ['count'], 'properties': {'count': {'type': 'integer', 'format': 'int32'}}, 'additionalProperties': False}}},
    ('car_car_id_floor_current', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'additionalProperties': False, 'properties': {'name': {'type': 'string'}, 'id': {'type': 'string'}}}}, 404: {'headers': None, 'schema': None}},
    ('admin_inventory_pwd', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'additionalProperties': False, 'type': 'object', 'properties': {'name': {'type': 'string'}, 'id': {'type': 'string'}}}}}, 401: {'headers': None, 'schema': None}},
}
